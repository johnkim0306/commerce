<template>
    <main class="mt-3">
      <div class="container">
        ...
        <div class="mb-3 row">
          <label class="col-md-3 col-form-label">Delivery Fee</label>
          <div class="col-md-9">
            <div class="input-group mb-3">
        ...
        <div class="mb-3 row">
          <label class="col-md-3 col-form-label">Additonal Delivery Fee(Out of province)</label>
          <div class="col-md-9">
            <div class="input-group mb-3">
        ...
        <div class="mb-3 row">
          <label class="col-md-3 col-form-label">Outbound Days</label>
          <div class="col-md-9">
            <div class="input-group mb-3">
