<template>
    <main class="mt-3">
      <div class="container">
        ...
        <div class="mb-3 row">
          <label class="col-md-3 col-form-label">Thumbnail Image</label>
          <div class="col-md-9">
            <div class="row">
            ...
            <div class="alert alert-secondary" role="alert">
              <ul>
                <li>Image size must be 350*350</li>
                <li>File size must be less than 1mb</li>
                <li>File Type must be jpeg/png</li>
              </ul>
            </div>
          </div>
        </div>
        <div class="mb-3 row">
          ...
          <div class="col-md-9">
            ...
            <div class="alert alert-secondary" role="alert">
              <ul>
                <li>Upto 5 Files</li>
                <li>Image size must be 700*700</li>
                <li>File size must be less than 1mb</li>
                <li>File Type must be jpeg/png</li>
              </ul>
            </div>
